...
const Home = () => {
  return (
    <div className='bg-gradient-to-r from-[#76AA64] to-[#4A6F3F] overflow-hidden mt-0 mb-0 ml-0 mr-0 h-screen w-screen'>
      <div className="bg-gradient-to-r from-[#76AA64] to-[#4A6F3F] h-full w-full flex items-center overflow-hidden">
        <div className="flex w-full h-[700px] max-w-7xl mx-auto">
          ...
          <div className="w-[40%] relative flex justify-center items-center">
            <div className="overflow-hidden aspect-square w-[80%] md:w-[600px] md:h-[600px] hidden md:block rounded-full">
              <img
